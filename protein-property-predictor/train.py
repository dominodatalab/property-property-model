...
#
# Usage:
#   export DATASET_DIR=/domino/datasets/<plane>/protein-property-predictor
#   python3 train.py
...
# Artifacts we want Domino to publish
...
def main():
    ...
    try:
        ...
        mlflow.set_tracking_uri(f"file://mnt/artifacts")
    ...
    # --- Optional: quick diagnostic histogram ---
    if _HAS_PLT:
        try:
